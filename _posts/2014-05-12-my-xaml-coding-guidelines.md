---
layout: post
title: My XAML coding guidelines
slug: my-xaml-coding-guidelines
date: 2014-05-12 15:16:30Z
---

`XAML` files are where I spend the most of my coding time. Sometimes, they can get quite messy. In C#, we do have *plenty* of coding guidelines and standards, like:

- [Microsoft Design Guidelines for developing Class Libraries](http://msdn.microsoft.com/en-us/library/vstudio/ms229042(v=vs.100).aspx), 
- [SubMain .NET Coding Guidelines](http://submain.com/download/guidelines/),
- [Philips C# Coding Standards](http://www.tiobe.com/content/paperinfo/gemrcsharpcs.pdf)

So, I've written down a list of guidelines I try to follow each time I create or edit a Xaml file.

I've set-up a Git repository - [XAML Coding Guidelines](http://github.com/cmaneu/xaml-coding-guidelines) with these rules. **Do not hesitate to [create an issue](https://github.com/cmaneu/xaml-coding-guidelines/issues/new) if you have an argument or a proposal for a new rule**.


This is an extract of the rules at the writing time. **Please go to the [XAML Coding Guidelines repository](http://github.com/cmaneu/xaml-coding-guidelines) to read the latest version**.

*Thanks to [@julieknibbe](http://twitter.com/julieknibbe), [@carl_b_anderson](https://twitter.com/carl_b_anderson), [@LoicRebours](https://twitter.com/LoicRebours) and [@ThomasNigro](https://twitter.com/ThomasNigro) for reviewing these guidelines !*  
